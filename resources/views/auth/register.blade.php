                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <select name="sex" class="custom-select @error('sex') is-invalid @enderror">
                                  <option value="" <?php if(old('sex') === null) echo 'selected'; ?>>Sex</option>
                                  <option value="1" <?php if(old('sex') == "1") echo 'selected'; ?>>Male</option>
                                  <option value="0" <?php if(old('sex') == "0") echo 'selected'; ?>>Female</option>
                                </select>
